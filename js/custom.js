...
function initialize() {
    var mapOptions = {
      zoom: 16,
      center: new google.maps.LatLng(-26.551116, 153.096183),
      scrollwheel: false
    };
...
function loadGoogleMap(){
    ...
    script.src = 'https://maps.googleapis.com/maps/api/js?key=AIzaSyBtTMVOh96-eVHOzUH63nY4-5-iOhqTrEE&callback=initialize';
